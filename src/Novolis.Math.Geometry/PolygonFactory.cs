...
public static partial class PolygonFactory
{
    ...
    public static Polygon CreateSphere(float radius, int segments)
    {
        ...
        var step = (float)(System.Math.PI * 2 / segments);
        for (var i = 0; i < segments; i++)
        {
            ...
            {
                var angle2 = step * j;
                polygon[i * segments + j] = new Vector3((float)System.Math.Cos(angle) * (float)System.Math.Cos(angle2) * radius,
                    (float)System.Math.Sin(angle) * (float)System.Math.Cos(angle2) * radius, (float)System.Math.Sin(angle2) * radius);
            }
        }
    ...
    public static Polygon CreateCylinder(float radius, float height, int segments)
    {
        ...
        for (var i = 0; i < segments; i++)
        {
            ...
            polygon[i + segments] =
                new Vector3((float)System.Math.Cos(angle) * radius, (float)System.Math.Sin(angle) * radius, height);
        }
